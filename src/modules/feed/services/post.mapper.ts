  ...
  private parseMessage(message: string): PostMessage {
    ...
    if (pictureMatche) {
     ...
     attachements.push({
      ...
      message = message.substring(0, pictureMatche.index);
    }
    ...
    if (videoMatche) {
      ...
      attachements.push({
        ...
        message = message.substring(0, videoMatche.index);
    }
    ...
    if (audioMatche) {
     // TODO ajouter un attachement de type audio dans attachements
      attachements.push({
        ...
        message = message.substring(0, audioMatche.index);
    }
    ...
    if (youtubeMatche) {
     // TODO ajouter un attachement de type youtube dans attachements
      attachements.push({
        ...
        message = message.substring(0, youtubeMatche.index - 1);
